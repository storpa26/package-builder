...
export type StoreyType = 'single' | 'multi';

interface StoreyTypeSelectorProps {
  value: StoreyType | null;
  onChange: (type: StoreyType) => void;
}

export function StoreyTypeSelector({ value, onChange }: StoreyTypeSelectorProps) {
  const options = [
    {
